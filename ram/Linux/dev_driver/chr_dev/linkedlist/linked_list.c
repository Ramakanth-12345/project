...
//struct kobj_attribute etx_attr = __ATTR(etx_value, 0777, sysfs_show, sysfs_store);
struct kobj_attribute etx_attr = __ATTR(etx_value, 0670,sysfs_show, sysfs_store);
/******************************************************/
