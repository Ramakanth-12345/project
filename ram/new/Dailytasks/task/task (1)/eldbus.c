#include "Eldbus.h"
#include <Ecore.h>
static void on_dial(void *data EINA_UNUSED, const Eldbus_Message *msg, Eldbus_Pending *pending EINA_UNUSED)
{
...
int main(int argc, char *argv[])
{
   ...
   pending = eldbus_proxy_call(manager, "Dial", on_dial, NULL,-1, "ss", number, hide_callerid);
   if (!pending)
     {
